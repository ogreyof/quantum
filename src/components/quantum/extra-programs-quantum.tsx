...
import { Calendar, Clock, Star, Play, CheckCircle, Lock, Camera } from "lucide-react";
...
interface ExtraProgramsQuantumProps {
  className?: string;
  onProgramSelect: (programId: string) => void;
}

export function ExtraProgramsQuantum({ className, onProgramSelect }: ExtraProgramsQuantumProps) {
  ...
  const extraPrograms: ExtraProgram[] = [
    {
      ...
      duration: 21,
      sessionTime: 10,
      description: 'Programa de 21 dias para eliminar tensões acumuladas do trabalho',
    ...
    },
    {
      ...
      duration: 7,
      sessionTime: 15,
      description: 'Programa intensivo para liberar nódulos musculares de movimentos repetitivos',
      ...
      completed: false,
      progress: 0,
      special: 'Ideal para movimentos repetitivos'
    },
    {
      id: 'drenagem-facial',
      ...
      duration: 21,
      sessionTime: 7,
      description: 'Programa estético com fotos de antes e depois para acompanhar resultados',
      ...
      completed: false,
      progress: 0,
      special: 'Com fotos antes/depois'
    },
    {
      id: 'forca-capilar',
      title: 'Força Capilar',
      duration: 30,
      sessionTime: 8,
      description: 'Fortalecimento intensivo dos folículos capilares em 30 dias',
      ...
      completed: false,
      progress: 0,
      special: 'Focado em fortalecimento'
    },
    {
      id: 'pernas-leves',
      title: 'Pernas Leves',
      duration: 14,
      sessionTime: 10,
      description: 'Programa para melhorar circulação e reduzir sensação de peso nas pernas',
    ...
    },
    {
      ...
      duration: 7,
      sessionTime: 7,
      description: 'Alívio rápido e eficaz para dores na sola do pé e esporão',
      ponteira: 'Ponteira Profunda',
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div>
                    ...
                    {program.special && (
                      <p className="text-xs text-quantum-accent mt-1 font-medium">
                        ✨ {program.special}
                      </p>
                    )}
                  </div>
